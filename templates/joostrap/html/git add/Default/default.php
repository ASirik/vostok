...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <ul>
    ...
    <li class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>">
      ...
      <a class="btn btn-mini btn-primary" href="<?php echo $item->categoryLink; ?>">in <?php echo $item->categoryname; ?></a>
      <?php endif; ?>
      ...
      <?php endif; ?>
			...
			<a class="moduleItemReadMore btn btn-mini btn-primary" href="<?php echo $item->link; ?>">
