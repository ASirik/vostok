...
<div id="k2Container" class="userView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?> row-fluid">
		...
		<div class="userItemView<?php if(!$item->published || ($item->publish_up != $this->nullDate && $item->publish_up > $this->now) || ($item->publish_down != $this->nullDate && $item->publish_down < $this->now)) echo ' userItemViewUnpublished'; ?><?php echo ($item->featured) ? ' userItemIsFeatured' : ''; ?>">
			...
			<div class="userItemHeader">			
				...
				<span class="userItemDateCreated">
					<i class="icon-calendar"></i> <?php echo JHTML::_('date', $item->created , JText::_('K2_DATE_FORMAT_LC2')); ?>
				</span>
				<?php endif; ?>
		  ...
		  <div class="userItemLinks">
				...
				<div class="userItemCategory">
					...
					<a class="btn btn-mini btn-primary" href="<?php echo $item->category->link; ?>"><?php echo $item->category->name; ?></a>
				</div>
				<?php endif; ?>
		  ...
		  <?php endif; ?>  
			...
			<div class="userItemCommentsLink">
				...
				<?php else: ?>
					...
					<a class="btn btn-small btn-primary" href="<?php echo $item->link; ?>#itemCommentsAnchor">
