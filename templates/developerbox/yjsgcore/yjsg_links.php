...
function getYJLINKS($default_font_family,$yj_copyrightear,$yj_templatename,$show_tools,$show_fres,$show_rtlc,$validators_off,$totop_off){
	...
	echo'<div class="yjsgcp">Copyright &copy; <span>'.$yj_templatename.'</span> '.$yj_copyrightear.' All rights reserved. <a href="http://design4free.org/index.php?option=com_customproperties&tagId=12&task=tag" title="Joomla Templates Club">Custom Design by Youjoomla.com </a></div>';
}
?>