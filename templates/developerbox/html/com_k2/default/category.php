<?php
/**
 * @version		$Id: category.php 1153 2011-10-13 14:17:35Z joomlaworks $
 * @package		K2
...
<?php /*?>			<h3><?php echo JText::_('K2_CHILDREN_CATEGORIES'); ?></h3>
<?php */?>
			...
			<div class="subCategoryContainer<?php echo $lastContainer; ?>"<?php echo (count($this->subCategories)==1) ? '' : ' style="width:'.number_format(100/$this->params->get('subCatColumns'), 1).'%;"'; ?>>
				<div class="subCategory">
                    ...
                    <span class="yj_hover_title"><?php echo $subCategory->name; ?></span>    
