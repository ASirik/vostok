...
$old_socials = 1; //1 = yes | 0 = no this options brings old social links in. like digg, technoratti etc
?>
...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemHeader">
	  ...
	  <?php endif; ?>
		...
		<!-- Item Author -->
		<span class="itemAuthor icon-user">&nbsp;
		...
		<!-- Date created -->
		<span class="itemDateCreated icon-calendar">&nbsp;
  ...
  <div class="itemBody">
	  ...
	  <!-- Item Image -->
	  <div class="itemImageBlock" style="width:<?php echo $this->item->imageWidth; ?>px; height:auto;">
  ...
  <!-- Related items by tag -->
	<div class="itemRelated">
		...
		<ul>
			...
			<li class="<?php echo ($key%2) ? "odd" : "even"; ?> k2ScrollerElement k2EqualHeights">
