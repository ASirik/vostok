...
class MenuSystem{
		...
		function showMenu($pid, $level) {
			if (@$this->_nav[$pid]) {
				...
				} elseif($level >= 2 && ($this->_name == 'moo' || $this->_name == 'css')){
					echo "<ul><li class='jv-first-li png'><span class='png'>&nbsp;</span></li>";
				} else {
                    echo "<ul>";
                }			
				$i = 0;
				...
				if($level >= 1) {
					echo "<li class='jv-last-li png'><span class='png'>&nbsp;</span></li>";
				}
			echo "</ul>";
            }
		}
