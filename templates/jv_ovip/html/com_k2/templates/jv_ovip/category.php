...
<div id="k2Container" class="itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemListCategoriesBlock">
		...
		<div class="itemListCategory">
			...
			<!-- Category title -->
			<h3><?php echo $this->category->name; ?><?php if($this->params->get('catTitleItemCounter')) echo ' ('.$this->pagination->total.')'; ?></h3>
			<?php endif; ?>
	...
	<div class="itemList">
		...
		<div id="itemListLeading">
			...
			<div class="itemContainer" style="width:<?php echo number_format(99/$this->params->get('num_leading_columns'), 1); ?>%;">
			<?php
		...
		<div id="itemListPrimary">
			...
			<div class="itemContainer" style="width:<?php echo number_format(99/$this->params->get('num_primary_columns'), 1); ?>%;">
			<?php
				// Load category_item.php by default
				$this->item=$item;
				echo $this->loadTemplate('item');
		...
		<div id="itemsListSecondary">
			...
			<div class="itemContainer" style="width:<?php echo number_format(99/$this->params->get('num_secondary_columns'), 1); ?>%;">
			<?php
				// Load category_item.php by default
				$this->item=$item;
				echo $this->loadTemplate('item');
		...
		<div id="itemListLinks">
			...
			<div class="itemContainer" style="width:<?php echo number_format(99/$this->params->get('num_links_columns'), 1); ?>%;">
			<?php
