		...
		<ul>
			...
			<li>
				...
				<a href="#" id="fontDecrease">
					...
					<img src="components/com_k2/images/system/font_decrease.gif" alt="<?php echo JText::_('decrease font size'); ?>" />
				</a>
				<a href="#" id="fontIncrease">
					<span><?php echo JText::_('increase font size'); ?></span>
					<img src="components/com_k2/images/system/font_increase.gif" alt="<?php echo JText::_('increase font size'); ?>" />
				</a>
			</li>
			<?php endif; ?>
