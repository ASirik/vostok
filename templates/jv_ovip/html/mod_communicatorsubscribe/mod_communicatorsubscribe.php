 ...
 * @version $Id: mod_communicatorsubscribe.php 306 2008-06-04 13:58:34Z Suami $
 */
...
if(!file_exists(JPATH_SITE . "/components/com_communicator/communicator.php")) {
	...
	if( $my->id ) {
		...
		if ($position == 1) {?> <div style="float: left;"> <?php } ?>
		   <input name="task" type="radio" class="inputbox" id="cm_subscribe" value="subscribe" checked="checked"/>
			<label for="cm_subscribe"><?php echo JText::_('Subscribe'); ?></label><br/>
			<input name="task" type="radio" class="inputbox" id="cm_unsubscribe" value="unsubscribe" />
