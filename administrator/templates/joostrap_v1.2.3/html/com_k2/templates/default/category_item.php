...
<div class="catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<div class="catItemHeader">
	  ...
	  <?php endif; ?>
		...
		<span class="catItemAuthor">
			<?php echo K2HelperUtilities::writtenBy($this->item->author->profile->gender); ?> <a rel="author" href="<?php echo $this->item->author->link; ?>"><i class="icon-user"></i> <?php echo $this->item->author->name; ?></a>
		</span>
		<?php endif; ?>
  </div>
  ...
  <div class="catItemLinks">
		...
		<div class="catItemCategory">
			...
			<a class="btn btn-mini btn-primary" href="<?php echo $this->item->category->link; ?>"><?php echo $this->item->category->name; ?></a>
		</div>
		<?php endif; ?>
  ...
  <div class="clr"></div>
	...
	<div class="catItemCommentsLink">
		...
		<?php else: ?>
			...
			<?php else: ?>
			<a class="btn btn-small btn-primary" href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
	...
	<div class="catItemReadMore">
		<a class="k2ReadMore btn btn-small btn-primary" href="<?php echo $this->item->link; ?>">
