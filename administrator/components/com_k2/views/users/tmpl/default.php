  ...
  <table class="adminlist">
    <thead>
      <tr>
        ...
        <th style="text-align:left;"><?php echo JHTML::_('grid.sort',   JText::_('Username'), 'juser.username', @$this->lists['order_Dir'], @$this->lists['order'] ); ?></th>
    ...
    <tbody>
      ...
      <tr class="<?php echo "row$k"; ?>">
        ...
        <td align="center"><?php echo $row->lvisit;?></td>
