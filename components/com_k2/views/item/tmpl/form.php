...
<form action="index.php" enctype="multipart/form-data" method="post" name="adminForm" class="k2Frontend">

  <div id="toolbar" class="toolbar">
      <table class="toolbar" cellpadding="2" cellspacing="2" style="border-collapse:collapse;border:none;">
          <tbody>
              <tr>
  ...
  <div id="k2FrontendEditToolbar">
  	<h2 id="k2FrontendEditTitle" class="header icon-48-generic"><?php echo JText::_('Add/Edit Item'); ?></h2>
    <div class="clr"></div>
  </div>
      ...
      <tr>
        <td valign="top" style="width:640px;">
            ...
            <ul class="simpleTabsNavigation">
              ...
              <?php endif; ?>
              <?php if (count($this->K2PluginsItemOther) && $this->params->get('showK2Plugins')): ?>
            ...
            <div class="simpleTabsContent" id="simpleTabsContent4" style="display:none;">
              ...
              <table class="admintable" id="item_video_content">
                <tr>
                  ...
                  <td>
                  	<?php jimport('joomla.html.pane'); $pane = & JPane::getInstance('Tabs',$this->options); echo $pane->startPane('myPane');?>
        ...
        <td valign="top" style="width:300px;padding-left:5px;">
