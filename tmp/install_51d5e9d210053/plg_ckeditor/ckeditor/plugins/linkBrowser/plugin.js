		...
		if ( dialogName == 'link' || dialogName == 'image')
		{
			...
			dialogDefinition.addContents({
				...
				elements : [
				{
					id : 'linkBrowser',
					type : 'html',
					html: '<iframe src="'+path+'index.php?option=com_ckeditor&task=plugin&plugin=linkBrowser" id="iframeNextgen" allowtransparency="1" style="width:500px;height:280px;margin:0;padding:0;vertical-align: auto;"></iframe>'
				},
				]
			});
		}
